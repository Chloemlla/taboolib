...
subprojects {
    ...
    dependencies {
        ...
        compileOnly("org.tabooproject.reflex:reflex:1.2.1")
        compileOnly("org.tabooproject.reflex:analyser:1.2.1")
        // 测试依赖
        ...
        testImplementation("org.tabooproject.reflex:reflex:1.2.1")
        testImplementation("org.tabooproject.reflex:analyser:1.2.1")
