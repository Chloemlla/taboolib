...
public class PrimitiveLoader {
    ...
    public static void init() throws Throwable {
        ...
        long time = TabooLib.execution(() -> {
            ...
            // 加载反射模块
            load(REPO_REFLEX, TABOOPROJECT_GROUP + ".reflex", "reflex", "1.2.1", IS_ISOLATED_MODE, true, rule());
            load(REPO_REFLEX, TABOOPROJECT_GROUP + ".reflex", "analyser", "1.2.1", IS_ISOLATED_MODE, true, rule());
        });
